                ...
                <form action="update_pass_firstlog" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="password" maxlength="12" class="form-control" required name="password" id="pwd1">
                        </div>
                        
                        <div class="form-group">
                            <label>Confirmer le mot de passe</label>
                            <input type="password" maxlength="12" class="form-control" required  id="pwd2" equired onkeyup="verifyPassword()">
                        </div>
